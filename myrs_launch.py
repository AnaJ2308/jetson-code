...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'pointcloud__neon_.enable',            'default': 'true', 'description': 'pointcloud'},
                           {'name': 'pointcloud__neon_.stream_filter',     'default': '2', 'description': 'texture stream for pointcloud'},
                           {'name': 'pointcloud__neon_.stream_index_filter','default': '0', 'description': 'texture stream index for pointcloud'},
                           {'name': 'pointcloud__neon_.ordered_pc',        'default': 'false', 'description': ''},
                           {'name': 'pointcloud__neon_.allow_no_texture_points', 'default': 'false', 'description': "''"}
                          ]
